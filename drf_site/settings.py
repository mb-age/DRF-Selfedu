...
SECRET_KEY = 'django-insecure-mc0+phubtd-x7*od%5c=e3b$mr@vtsa6fsvx*5-&y#t1^aq%zd'
...
LANGUAGE_CODE = 'ru' # фреймворк джанго будет работать на русском языке
...
SIMPLE_JWT = { # просто скопировать с сайта, вкладка settings
